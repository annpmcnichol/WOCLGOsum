...
```{r}
# Load using read_csv
A20_cchdo <- read_csv("data/a20_hy1.csv", na_if = c("DELC14", "-999.0"))
...
I need to convert the expocode in the NOSAMS database from 316N151/3 to 316N151/3. Perhaps, I'll first extract this subset of data and then change the value. 
...
###Calculate D14C (seawater_dc14), need to define a variable
  lambda14 <- 0.00012097
  A20_nos.seawater_dc14 <- replace(A20_nos.seawater_dc14, A20_nos, (1000*(-1 + A20_nos$f_modern*exp(lambda14*(1950 - A20_nos$coll_yr)))))
